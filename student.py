...
class Student:
    ...
    sid = SHEET.worksheet("sid")  # Get the sid worksheet containing the student ID to iterate over

    def __init__(self, name: str, allergies="", dietary="", medication="", special_needs="", notes=""):
        """
        Initialize a new student.

        Args:
            name (str): The name of the student.
            allergies (str, optional): Any allergies the student has. Defaults value "".
            dietary (str, optional): Dietary restrictions of the student. Defaults value "".
            medication (str, optional): Medications taken by the student. Defaults value "".
            special_needs (str, optional): Special needs of the student. Defaults value "".
            notes (str, optional): Additional notes about the student. Defaults value "".
        """
        self.name = name
